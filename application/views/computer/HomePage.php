...
<div class="right-part">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10 text-center">
                <time id="time"><span id="days"></span><span id="hours"></span><span id="minutes"></span><span
                        id="seconds"></span></time>
            </div>
            <div class="col-md-1"></div>
        </div>
        <div class="row">
            ...
            <div class="col-md-11">
								 ...
								 <span class="remind">时间不多了，赶紧提交周报哦！</span>
            </div>
        </div>
    ...
    <div class="pager">
        <a class="btn btn-default active" href="WriteWeekly.html" role="button">撰写周报</a>
        <a class="btn btn-default" href="Leave.html" role="button">申请请假</a>
    </div>
...
<script type="text/javascript" src="/public/computer/js/countdown.js"></script>
<script type="text/javascript" src="/public/computer/js/ball-weeknum.js"></script>
</body>
</html>
