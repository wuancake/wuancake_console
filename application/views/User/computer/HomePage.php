...
<!--右边	-->	
		 <div class="right-part">
			...
			<div class="container-fluid">
  				<div class="row">
     				<div class="col-md-1"></div>
 						<div class="col-md-10 text-center">
 							<time id="time" ><span id="days"></span><span id="hours"></span><span id="minutes"></span><span id="seconds"></span></time>
 						</div>
 						<div class="col-md-1"></div>
  				</div>
  				<div class="row">
				...
				<div class="pager">
						<a class="btn btn-default active" href="/index.php/viewer/write_weekly" role="button">撰写周报</a>
						<a class="btn btn-default" href="/index.php/viewer/vacate" role="button">申请请假</a>
				</div>
    ...
    <script src="https://cdn.bootcss.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
		<script type="text/javascript" src="/public/User/computer/js/countdown.js" ></script>
