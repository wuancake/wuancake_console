...
//	var currentTime =(new Date(2017, 7, 25, 0, 0, 0)).getTime();
	...
	// 将时间转位天数
//	var offsetDays =Math.floor((offsetTime / (3600 * 24 * 1000))/7); //3600 * 24 * 1000=86400000
	var offsetDays =Math.floor((offsetTime / 86400000)/7); //3600 * 24 * 1000=86400000
...
//	alert(nw)
//
//$.getJSON('js/test.php',function(data){ 
//	
///*var strHtml = "";//存储数据的变量
//	var o = nw;
//  strHtml= 
...
//       $.ajax({
//          type:"get",
//          url:"api/weekly.php?week=1&session="+session_id,
//          dataType:'json',
//          cache:false,
//          data:{	
////          	    "status":"已提交",
